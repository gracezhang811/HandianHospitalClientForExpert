#ifndef _ZHUMU_MEETINGSERVICE_INTERFACE_H_
#define _ZHUMU_MEETINGSERVICE_INTERFACE_H_
/*!
...
#include <time.h>
#include <list>
#include "SettingService_interface.h"
using namespace std;
...
namespace ZHUMU_SDK_NAMESPACE {
	...
	*/
	...
	public:
		...
		virtual void onUserJoin(list<unsigned int >* lstUserID, const wchar_t* strUserList = NULL) = 0;

		/// \brief User left meeting notify callback
		/// \param lstUserID List of the user left.
		/// \param strUserList User list in json format,Reserved.
		virtual void onUserLeft(list<unsigned int >* lstUserID, const wchar_t* strUserList = NULL) = 0;
		...
		virtual void onUserAudioStatusChange(list<IUserAudioStatus* >* lstAudioStatusChange, const wchar_t* strAudioStatusList = NULL) = 0;
	...
	*/
	...
	public:
		...
		///If the function fails, the return value is NULL.
		virtual list<unsigned int >* GetViewableShareSourceList() = 0;
	...
	public:
		...
		virtual list<unsigned int >* GetParticipantsList() = 0;
		...
		virtual SDKError LowerHand(unsigned int useid) = 0;

		virtual SDKError RaiseHand() = 0;

		virtual SDKError MakeHost(unsigned int useid) = 0;

		virtual SDKError ExpelUser(unsigned int useid) = 0;

		virtual SDKError GetMeetingUIType(SDKMeetingUIType& sdkUIType) = 0;

		virtual SDKError StartStopCMR(BOOL isStart) = 0;

		virtual SDKError GetMicList(list<IMicInfo*>* micInfoListPtr) = 0;

		virtual SDKError GetSpeakerList(list<ISpeakerInfo*>* speakerInfoPtr) = 0;

		virtual SDKError SelectMic(wchar_t* DeviceId, wchar_t* DeviceName) = 0;

		virtual SDKError SelectSpeaker(wchar_t* DeviceId, wchar_t* DeviceName) = 0;

		virtual SDKError SetMicVol(float vol) = 0;

		virtual SDKError SetSpeakerVol(float vol) = 0;

		virtual SDKError DisAllowLocalRecording(unsigned int useid) = 0;

		virtual SDKError AllowLocalRecording(unsigned int useid) = 0;

		virtual SDKError ReclaimHost() = 0;

		virtual SDKError GetActiveUser(unsigned int& useid) = 0;
