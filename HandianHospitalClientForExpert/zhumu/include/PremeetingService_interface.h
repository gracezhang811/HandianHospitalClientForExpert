#ifndef _ZHUMU_PREMEETINGSERVICE_INTERFACE_H
#define _ZHUMU_PREMEETINGSERVICE_INTERFACE_H
...
namespace ZHUMU_SDK_NAMESPACE {
	...
	*/
	...
	public:
		...
		virtual void onListMeeting(PremeetingAPIResult result, list<UINT64 >* lstMeetingList) = 0;
...
#endif //_ZHUMU_PREMEETINGSERVICE_INTERFACE_H
