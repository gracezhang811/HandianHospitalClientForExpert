#ifndef _ZHUMU_AUTHSERVICE_INTERFACE_H_
#define _ZHUMU_AUTHSERVICE_INTERFACE_H_
/*!
...
namespace ZHUMU_SDK_NAMESPACE {
	...
	*/
	...
	public:
		...
		void SetAuthServiceEvent(IAuthServiceEvent* authEvent)
		{
			authServiceEvent = authEvent;
		}
		...
		IAuthServiceEvent* authServiceEvent;
