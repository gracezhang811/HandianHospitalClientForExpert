#ifndef _ZHUMU_MEETINGPHONEHELPER_INTERFACE_H_
#define _ZHUMU_MEETINGPHONEHELPER_INTERFACE_H_
...
namespace ZHUMU_SDK_NAMESPACE {
	...
	public:
		...
		virtual list<IMeetingPhoneSupportCountryInfo* >* GetSupportCountryInfo() = 0;
