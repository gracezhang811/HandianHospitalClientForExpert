#ifndef _ZHUMU_SETTINGSERVICE_INTERFACE_H_
#define _ZHUMU_SETTINGSERVICE_INTERFACE_H_
...
namespace ZHUMU_SDK_NAMESPACE {
	...
	public:
		...
		/// \return If the function succeeds, the return value is camera device id.
		///If the function fails, the return value is NULL.
		virtual void GetDeviceId(std::wstring& deviceId) = 0;

		/// \brief Get microphone device name
		/// \return If the function succeeds, the return value is camera device name.
		///If the function fails, the return value is NULL.
		virtual void GetDeviceName(std::wstring& deviceName) = 0;
	...
	*/
	...
	public:
		...
		///If the function fails, the return value is NULL.
		virtual list<ICameraInfo* >* GetCameraList() = 0;
